...
io.on('connection', function(socket) {
    ...
    socket.on('register',function(userStatus) {
        ...
        findDocuments({'username':user.username},'testCollection',function(cursor){
    ...
    socket.on('login',function(userStatus) {
        ...
        var user; findDocuments({'username':loginUser.username},'testCollection',function(cursor) {
            cursor.toArray(function(err,result){
                if (err) {
                    console.log(err);
                    return;
...
function findDocuments(filter,collectionName,callback) {
    var collection = db.collection(collectionName);
    callback(collection.find(filter));
